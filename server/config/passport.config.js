...
if (!process.env.GOOGLE_CLIENT_ID || !process.env.GOOGLE_CLIENT_SECRET) {
  logger.warn('Google OAuth credentials are not set. Google login will be unavailable.');
} else {
  passport.use(
    new GoogleStrategy(
      {
...
if (!process.env.TWITTER_CLIENT_ID || !process.env.TWITTER_CLIENT_SECRET) {
  logger.warn('Twitter OAuth credentials are not set. Twitter login will be unavailable.');
} else {
  passport.use(
    new TwitterStrategy(
      {
