...
- **Admin Client**: [https://admin.deployserver.work/](https://admin.deployserver.work)
- **Kibana Dashboard**: [https://kibana.deployserver.work/](https://kibana.deployserver.work)
